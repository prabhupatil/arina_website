...
<body>
  ...
  <main>
    ...
    <section class="about-hero">
      ...
      <h1 class="section-title" style="max-width:1000px;margin:0 auto 40px; margin-top: 80px !important;"
        id="section-title">Unified Intelligence Layer
        for All Technology Operations</h1>
      <p class="section-desc" style="margin:0 auto">With decades of experience on-call across SRE, NOC, and platform
        teams, we saw siloed ops teams drowning in alerts, solving the same problems in isolation.<br><br><b
          id="text">Arina unifies these teams and connects their efforts.</b></p>
    </section>
...
<div class="team-card"><div class="team-avatar">DK</div><h3>David Kim</h3><div class="role">Head of AI/ML</div><p class="bio">PhD in distributed systems. Former researcher at a top AI lab focused on autonomous operations.</p></div>
    ...
    <section class="section1">
      ...
      <div class="platform-banner">
        ...
        <div>
          <h2>Make Every Ops Team Superhuman</h2>
          <p>Every minute of downtime costs revenue, erodes trust, and burns out engineers. But the highest hidden cost
            is fragmentation with all ops teams working with different tools, different data, and different contexts. We
            believe a single AI platform that serves all ops functions from a shared intelligence layer can
            fundamentally transform how technology organizations operate.</p>
        </div>
    ...
    <section class="section section-center" id="section2">
      ...
      <div class="values-grid">
        <div class="value-card">
          <div class="feature-icon"><img src="logo/Ops-First Design.png" height="35px" width="35px"
              alt="Ops-First Design"></div>
          <h3>Ops-First Design</h3>
          <p>We build for every ops practitioner: SREs, NOC analysts, security engineers, data engineers, and IT
            operators. Every feature reduces toil across disciplines.</p>
        </div>
        <div class="value-card">
          <div class="feature-icon"><img src="logo/Transparency in AI.png" height="35px" width="35px"
              alt="Transparency in AI"></div>
          <h3>Transparency in AI</h3>
          <p>Arina always shows its reasoning. No black boxes. Every diagnosis comes with evidence, confidence scores,
            and cross-domain context.</p>
        </div>
        <div class="value-card">
          <div class="feature-icon"><img src="logo/One Platform.png" height="35px" width="35px" alt="One Platform">
          </div>
          <h3>Unified Platform</h3>
          <p>The industry has too many siloed tools. We believe one unified AI platform serving all ops teams creates
            exponentially more value than separate tools for each.</p>
        </div>
        <div class="value-card">
          <div class="feature-icon"><img src="logo/Continuous Learning.png" height="35px" width="35px"
              alt="Continuous Learning"></div>
          <h3>Continuous Learning</h3>
          <p>Arina improves with every incident across every ops domain. Cross-domain feedback loops drive accuracy and
            surface patterns no single team could find alone.</p>
        </div>
        <div class="value-card">
          <div class="feature-icon"><img src="logo/Integrate.png" height="35px" width="35px"
              alt="Integrate Don't Replace"></div>
          <h3> No Replacement </h3>
          <p>We enhance your existing tools (Datadog, PagerDuty, ServiceNow, Snyk, and Snowflake) instead of asking you
            to rip and replace.</p>
        </div>
        <div class="value-card">
          <div class="feature-icon"><img src="logo/Security Without Compromise.png" height="35px" width="35px"
              alt="Security Without Compromise"></div>
          <h3>Fully Secure</h3>
          <p>Enterprise-grade security is table stakes. VPC deployable, read-only by default, with per-team governance
            controls</p>
        </div>
      </div>
    </section>
